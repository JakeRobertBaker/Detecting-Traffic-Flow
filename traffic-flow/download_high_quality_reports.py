...
if argument in ['birmingham', 'all']:
    ...
    clean_birmingham_report_df_norm.reset_index(drop=True).to_feather('high_quality_traffic_reports/clean_birmingham_report_df_norm')
...
if argument in ['manchester', 'all']:
    ...
    clean_manchester_report_df_norm.reset_index(drop=True).to_feather('high_quality_traffic_reports/clean_manchester_report_df_norm')
...
if argument in ['cambridge', 'all']:
    ...
    clean_cambridge_report_df_norm.reset_index(drop=True).to_feather('high_quality_traffic_reports/clean_cambridge_report_df_norm')
...
if argument in ['thorpe', 'all']:
    ...
    clean_thorpe_report_df_norm.reset_index(drop=True).to_feather('high_quality_traffic_reports/clean_thorpe_report_df_norm')
...
if argument in ['epping', 'all']:
    ...
    clean_epping_report_df_norm.reset_index(drop=True).to_feather('high_quality_traffic_reports/clean_epping_report_df_norm')
...
if argument in ['bristol', 'all']:
    ...
    clean_bristol_report_df_norm.reset_index(drop=True).to_feather('high_quality_traffic_reports/clean_bristol_report_df_norm')